<template>
  <div class="ms-wrap" v-if="paramIsTrue">
    <img class="bg-img" src="../../../assets/img/crz/crz-bg.jpg">
    ...
    <div class="ms-con ms-msg">
      <img class="my-img" :src="crzdata.txImg" alt="头像">
    ...
    <div class="ms-con ms-btn">
      <el-button type="primary" @click="toFront()">关闭</el-button>
    </div>
  </div>
</template>
...
export default {
    data: function() {
        return {
            ...
            crzdata: {
                add: localStorage.getItem('crzadd') || this.$route.params.add,
                uname: localStorage.getItem('crzname') || this.$route.params.username,
                buildingNo: '32号楼2单元601',
                urelation: '非业主(承租人)',
                txImg: localStorage.getItem('crzimglocal') || './img/crz/' + this.$route.params.txImg + '.jpg'
            },
            paramIsTrue: true
        };
    },
